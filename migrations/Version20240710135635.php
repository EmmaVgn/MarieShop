 ...
 */
final class Version20240710135635 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE advise ADD images_id INT DEFAULT NULL, DROP image');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE advise ADD image VARCHAR(255) NOT NULL, DROP images_id');
    }
}
